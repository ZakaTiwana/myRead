...
export class DataService {
  ...
  login(author: author): Observable<any> {
    return this.http.post<any>(this.url.concat("/login"), author, httpOptions);
  }

  signup(author: author): Observable<any> {
    return this.http.post<any>(this.url.concat("/register"), author, httpOptions);
  }
}